  ...
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
        <div>
            ...
            <p className='py-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Adipisci ab accusamus explicabo blanditiis qui itaque reiciendis mollitia inventore odio harum.</p>
        ...
        <div className='lg:col-span-2 flex justify-between mt-6'>
            <div>
                ...
                <ul>
                    ...
                    <li className='py-2 text-small'>Insides</li>
                </ul>
            </div>
            <div>
